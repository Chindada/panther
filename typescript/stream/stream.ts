...
/**
 * @generated from protobuf message stream.SubscribeFutureRequest
 */
export interface SubscribeFutureRequest {
    /**
...
// @generated message type with reflection information, may provide speed optimized methods
class SubscribeFutureRequest$Type extends MessageType<SubscribeFutureRequest> {
    constructor() {
        super("stream.SubscribeFutureRequest", [
            { no: 1, name: "code", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<SubscribeFutureRequest>): SubscribeFutureRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.code = "";
        if (value !== undefined)
            reflectionMergePartial<SubscribeFutureRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SubscribeFutureRequest): SubscribeFutureRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SubscribeFutureRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string code = 1; */
        if (message.code !== "")
...
/**
 * @generated MessageType for protobuf message stream.SubscribeFutureRequest
 */
export const SubscribeFutureRequest = new SubscribeFutureRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
export const StreamInterface = new ServiceType("stream.StreamInterface", [
    { name: "SubscribeShioajiEvent", serverStreaming: true, options: {}, I: Empty, O: ShioajiEvent },
    { name: "SubscribeFutureTick", serverStreaming: true, options: {}, I: SubscribeFutureRequest, O: FutureTick },
    { name: "SubscribeFutureBidAsk", serverStreaming: true, options: {}, I: SubscribeFutureRequest, O: FutureBidAsk }
]);
