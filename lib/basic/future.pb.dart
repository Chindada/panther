...
/// }
class FutureDetail extends $pb.GeneratedMessage {
  factory FutureDetail({
  ...
  factory FutureDetail.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory FutureDetail.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FutureDetail', package: const $pb.PackageName(_omitMessageNames ? '' : 'basic'), createEmptyInstance: create)
  ...
  FutureDetail clone() => FutureDetail()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FutureDetail copyWith(void Function(FutureDetail) updates) => super.copyWith((message) => updates(message as FutureDetail)) as FutureDetail;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static FutureDetail create() => FutureDetail._();
  @$core.override
  FutureDetail createEmptyInstance() => create();
  static $pb.PbList<FutureDetail> createRepeated() => $pb.PbList<FutureDetail>();
  @$core.pragma('dart2js:noInline')
  static FutureDetail getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FutureDetail>(create);
  static FutureDetail? _defaultInstance;
