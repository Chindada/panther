...
@$core.Deprecated('Use optionDetailDescriptor instead')
const OptionDetail$json = {
  '1': 'OptionDetail',
  '2': [
    ...
    {'1': 'strike_price', '3': 17, '4': 1, '5': 1, '10': 'strikePrice'},
...
/// Descriptor for `OptionDetail`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List optionDetailDescriptor = $convert.base64Decode(
    'CgxPcHRpb25EZXRhaWwSGgoIY2F0ZWdvcnkYASABKAlSCGNhdGVnb3J5EhIKBGNvZGUYAiABKA'
    ...
    'Y2UYESABKAFSC3N0cmlrZVByaWNlEhYKBnN5bWJvbBgSIAEoCVIGc3ltYm9sEh8KC3RhcmdldF'
