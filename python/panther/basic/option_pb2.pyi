...
class OptionDetailList(_message.Message):
    __slots__ = ("list",)
    LIST_FIELD_NUMBER: _ClassVar[int]
    list: _containers.RepeatedCompositeFieldContainer[OptionDetail]
    def __init__(self, list: _Optional[_Iterable[_Union[OptionDetail, _Mapping]]] = ...) -> None: ...
