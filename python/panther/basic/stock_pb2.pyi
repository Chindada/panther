...
class StockDetail(_message.Message):
...
class StockDetailList(_message.Message):
    __slots__ = ("list",)
    LIST_FIELD_NUMBER: _ClassVar[int]
    list: _containers.RepeatedCompositeFieldContainer[StockDetail]
    def __init__(self, list: _Optional[_Iterable[_Union[StockDetail, _Mapping]]] = ...) -> None: ...
